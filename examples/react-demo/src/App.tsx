...
import { ArrowLeft, Tag, Users, Cpu, Home, Package, BookOpen, Layers } from 'lucide-react';
import { ProductMaster } from './features/products/ProductMaster';
...
const SAMPLE_SCHEMAS: Record<string, EntitySchema> = {
  ...
  product: {
    ...
    sampleData: {
      title: "Stepper Motor NEMA 23",
      sku: "MOT-N23-4200",
      price: "$58.50",
      serialNumber: "SN-MOT-2026-1001",
      batchNo: "LOT-2026-Q1",
      mfgDate: "2026-02-15"
    }
  }
...
type MainView = 'home' | 'docs' | 'labels' | 'products' | 'employees' | 'machines' | 'storage';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col lg:flex-row items-center justify-between py-4 gap-4">
                ...
                <div className="w-full lg:w-auto overflow-x-auto pb-1 lg:pb-0 scrollbar-hide -mx-4 px-4 lg:mx-0 lg:px-0">
                  <nav className="flex gap-1.5 sm:gap-2 bg-gray-100 p-1 sm:p-1.5 rounded-xl w-max mx-auto lg:mx-0">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-5 py-2.5 font-semibold transition-all duration-200 rounded-lg cursor-pointer ${mainView === 'products'
                ...
                <div className="hidden lg:flex items-center gap-3">
                  <button
                    onClick={() => {
                      if (confirm('Are you sure? This will reset all demo database records.')) {
                        storage.clearAll();
                        setLabels([]);
                        window.location.reload();
                      }
